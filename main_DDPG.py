...
from algorithm import DDPG_GILD
from algorithm import DDPG_GILD_ws
...
if __name__ == "__main__":
    ...
    parser.add_argument("--method", default="DDPG_GILD_ws")  # Policy name
    parser.add_argument("--seed", default=8, type=int)  # Sets Gym, PyTorch and Numpy seeds
    ...
    if 'ws' in args.method:
        policy = DDPG_GILD_ws.DDPG_GILD(state_dim, action_dim, max_action, demo_traj, args)
    else:
        policy = DDPG_GILD.DDPG_GILD(state_dim, action_dim, max_action, demo_traj, args)
